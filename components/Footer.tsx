        ...
        <footer className="bg-black text-white py-12 px-4 relative z-10 border-t-4 border-white w-full">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
                <div>
                    ...
                    <p className="text-sm font-medium text-gray-400">{t('appFooter.about')}</p>
                    <p className="mt-4 text-xs font-mono text-gray-600">CC0 {new Date().getFullYear()} BeeNouns.</p>
                </div>
                <div className="flex flex-col items-center md:items-start">
                    <h4 className="text-xl font-bold uppercase mb-4 text-white">{t('appFooter.follow')}</h4>
                ...
                <div className="flex flex-col items-center md:items-start">
                    <h4 className="text-xl font-bold uppercase mb-4 text-white">{t('appFooter.community')}</h4>
